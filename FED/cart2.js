...
function addToCartClicked(event) {
    ...
    var imageSrc = shopItem.getElementsByClassName('promo')[0].src
...
function addItemToCart(title, price, imageSrc) {
    ...
    for (var i = 0; i < cartItemNames.length; i++) {
        if (cartItemNames[i].innerText == title) {
            alert('This is already added to your cart. Check your cart! ')
            return
        }
    }
    var cartRowContents = `
        <div class="cart-item cart-column">
            <img class="promo" src="${imageSrc}" width="100" height="100">
